...
export const api = {
  ...
  avatar: {
    ...
    furniture: () => req('GET', '/avatar/furniture'),
    buyFurniture: (id) => req('POST', `/avatar/furniture/buy/${id}`),
    emotes: () => req('GET', '/avatar/emotes'),
    buyEmote: (id) => req('POST', `/avatar/emotes/buy/${id}`),
    equipEmote: (id) => req('POST', `/avatar/emotes/equip/${id}`),
